async function main() {
  ...
  // Prepare buffers to store shader results
  ...
  // Prepare buffers to read back (map read) results to javascript
  ...
  // Setup a bindGroup to bind all our storage buffers
  ...
  // Copy results from storage buffers to mappable buffers
